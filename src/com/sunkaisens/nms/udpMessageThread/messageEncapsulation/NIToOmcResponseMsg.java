...
/**
 * NI发送给OMC,OMC回复的响应消息 (0x8013)
 */
public class NIToOmcResponseMsg extends CncpBaseMsg {
	...
	public NIToOmcResponseMsg() {
		super();
	}
	
	public NIToOmcResponseMsg(char srcType,char destType,int messageLength,int messageType,int transId,int neType,int instId,char subType,char holdBit,char result,char resultHoldBit) {
	 ...
	 * 设置响应消息
	 */
	public NIToOmcResponseMsg readFromSetUpResponseMsg(byte[] bytes, NIToOmcResponseMsg setUpMsg) {
		//上报消息的源地址
